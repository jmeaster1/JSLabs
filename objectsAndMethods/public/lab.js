...
/****************** Your Solution ******************/
mage.learnSpell = function(obj) {
  if (typeof obj === 'object') {
    if (obj.requiredLvl <= this.lvl) {
      this.spells[obj.name] = obj;
...
/****************** Your Solution ******************/
magicMissile.resolve = function(mage, foe){
  var damageTaken = mage.lvl * Math.round((Math.random()* 3)+4);
  foe.hp = foe.hp- damageTaken;
  return damageTaken;
...
//mage.castSpell('magicMissile', darkness);
console.log(darkness);
